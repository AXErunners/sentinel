...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to axed "gobject list" output
    ...
    def axed_serialise(self):
        import axelib
        return axelib.SHIM_serialise_for_axed(self.serialise())
