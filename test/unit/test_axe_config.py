...
def test_get_rpc_creds():
    ...
    assert creds.get('user') == 'axerpc'
    assert creds.get('password') == 'EwJeV3fZTyTVozdECF627BkBMnNDwQaVLakG3A4wXYyk'
    assert creds.get('port') == 9936


# ensure axe network (mainnet, testnet) matches that specified in config
# requires running axed on whatever port specified...
#
# This is more of a axed/jsonrpc test than a config test...
